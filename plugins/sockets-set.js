...
let handler = async (m, { conn }) => {
  ...
  let txt = `Personalizaciones del Socket:

#setname + *<nuevo_nombre>*
> -> Cambia el nombre de tu *Sub-Bot.*
#setbanner *<nueva_foto>*
> -> Cambia la foto de tu *Sub-Bot.*
#setcurrency o #setmoneda *<nueva_moneda>*
> -> Cambia la moneda de tu *Sub-Bot.*

¡Recuerda que estos comandos solo están disponibles para los *Sub-Bots!*
> Te Deseo un hermoso y maravilloso día!`.trim()
